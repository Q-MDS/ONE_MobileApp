...
const AnalysisOverall = ( props: any) => 
{
    ...
    const panResponder = useRef(
        PanResponder.create({
          ...
          onPanResponderMove: (_, gestureState) => 
          {
            ...
            {
                props.navigation.navigate('AnalysisPhysical')
            }
          },
            ...
            <ImageBackground source={backgroundImage} style={MainStyles.imageBackground}>
                ...
                <Text style={[ MainStyles.h2, MainStyles.textSerif, MainStyles.textLeft, MainStyles.w_100]}>Analysis</Text>
                    ...
                    <TabStyleButtonGroup
                        ...
                        navTo={['AnalysisOverall','OverallAccountabilityScore', 'OverallBalanceLevel', 'OverallRewards']}
                        />
                        ...
                        <ProgressCircle
                            ...
                            bgColor="#f6fafd"
                        >
                            <Text style={[MainStyles.h1, MainStyles.mb_0]}>{'80%'}</Text>
                        </ProgressCircle>

                        <Text style={[MainStyles.h2, MainStyles.textBold, MainStyles.mt_3, MainStyles.mb_2]}>Overall</Text>
                        <Text style={[MainStyles.h6, MainStyles.mb_5]}>You completed 80% of your overall activities for the week.</Text>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', columnGap: 10 }}>
                            <View style={{flex:1}}>
                            <Progress.Bar progress={(97/122)} width={null}  color={'#4A4A4A'} height={20} unfilledColor={'#c9cbd1'} borderRadius={10} />
                            </View>
                            <View>
                            <Text style={[MainStyles.h6, MainStyles.mb_0]}>97/122</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', columnGap: 10 }}>
                            <View style={{flex:1}}>
                            <Progress.Bar progress={(54/62)} width={null}  color={'#4A4A4A'} height={20} unfilledColor={'#c9cbd1'} borderRadius={10} />
                            </View>
                            <View>
                            <Text style={[MainStyles.h6, MainStyles.mb_0]}>97/122</Text>
                            </View>
...
export default AnalysisOverall