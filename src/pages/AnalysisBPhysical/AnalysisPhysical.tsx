...
const AnalysisPhysical = ( props: any) => 
{
            ...
            <ImageBackground source={backgroundImage} style={MainStyles.imageBackground}>
                ...
                <Text style={[ MainStyles.h2, MainStyles.textSerif, MainStyles.textLeft, MainStyles.w_100]}>Analysis</Text>
                    ...
                    <TabStyleButtonGroup
                        ...
                        <Text style={[MainStyles.h2, MainStyles.textBold, MainStyles.mt_3, MainStyles.mb_2]}>Physical</Text>
                        <Text style={[MainStyles.h6, MainStyles.mb_5]}>You completed 94% of your Physical activities.</Text>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', columnGap: 10 }}>
                            ...
                            <View>
                            <Text style={[MainStyles.h6, MainStyles.mb_0]}>102/122</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', columnGap: 10 }}>
                            <View style={{flex:1}}>
                            <Progress.Bar progress={(28/62)} width={null}  color={'#4A4A4A'} height={20} unfilledColor={'#c9cbd1'} borderRadius={10} />
                            </View>
                            <View>
