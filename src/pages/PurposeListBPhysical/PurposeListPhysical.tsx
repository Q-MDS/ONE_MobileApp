...
const PurposeListPhysical = ( props: any ) => 
{
    ...
    const handleOkay = () => 
    {
        props.navigation.navigate('PurposeListEmotional')
    };
    ...
    return (
        <ImageBackground source={backgroundImage} style={MainStyles.imageBackground}>
            ...
            >
                ...
                <Text style={ MainStyles.h5}>The purpose of Physical Health is to work on the physical form, to provide body mobility and it's function.</Text>
                <View style={MainStyles.div}>
                    ...
                    <PageIndicator style={[MainStyles.mt_4]} count={5} current={1}/>
                </View>
            </View>
        </ImageBackground>
    );
...
export default PurposeListPhysical;