...
const AnalysisEmotional = ( props: any) => 
{
                ...
                <Text style={[ MainStyles.h2, MainStyles.textSerif, MainStyles.textLeft, MainStyles.w_100]}>Analysis</Text>
                    ...
                    <TabStyleButtonGroup
                        ...
                        <ProgressCircle
                            ...
                            bgColor="#f6fafd"
                        >
                            <Text style={[MainStyles.h1, MainStyles.mb_0]}>{'66%'}</Text>
                        </ProgressCircle>

                        <Text style={[MainStyles.h2, MainStyles.textBold, MainStyles.mt_3, MainStyles.mb_2]}>Emotional</Text>
                        <Text style={[MainStyles.h6, MainStyles.mb_5]}>You completed 66% of your Emotional activities.</Text>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', columnGap: 10 }}>
                            <View style={{flex:1}}>
                            <Progress.Bar progress={(9/14)} width={null}  color={'#4A4A4A'} height={20} unfilledColor={'#c9cbd1'} borderRadius={10} />
                            </View>
                            <View>
                            <Text style={[MainStyles.h6, MainStyles.mb_0]}>9/14</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', columnGap: 10 }}>
                            <View style={{flex:1}}>
                            <Progress.Bar progress={(8/12)} width={null}  color={'#4A4A4A'} height={20} unfilledColor={'#c9cbd1'} borderRadius={10} />
                            </View>
                            <View>
                            <Text style={[MainStyles.h6, MainStyles.mb_0]}>8/12</Text>
                            </View>
                        </View>
                        <PageIndicator
...
export default AnalysisEmotional