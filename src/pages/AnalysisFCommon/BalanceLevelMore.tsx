...
const BalanceLevelMore = () => {
  return (
    <View style={[MainStyles.container, { paddingTop: 10}]}>
        <BackButton/>
        <ScrollView>
        <Text style={[MainStyles.h2, MainStyles.textCenter, MainStyles.textSerif]}>Balance Level</Text>
        ...
        <Text style={[MainStyles.h6, MainStyles.textLeft, MainStyles.textBold, MainStyles.mb_2]}>Here's how the Balance Level works:</Text>
        ...
        <Text style={[MainStyles.h6, MainStyles.textLeft, MainStyles.textBold, MainStyles.mb_2]}>For instance:</Text>
...
export default BalanceLevelMore;