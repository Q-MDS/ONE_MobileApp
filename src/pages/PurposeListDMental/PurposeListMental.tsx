...
const PurposeListMental = ( props: any ) => 
{
    ...
    const handleOkay = () => 
    {
        props.navigation.navigate('PurposeListSpiritual')
    };
        ...
        <ImageBackground source={backgroundImage} style={MainStyles.imageBackground}>
            ...
            <Text style={[ MainStyles.h1, MainStyles.textSerif]}>Mental</Text>
                ...
                <View style={MainStyles.div}>
                    ...
                    <PageIndicator style={[MainStyles.mt_4]} count={5} current={3}/>
                </View>
            </View>
        </ImageBackground>
    );
...
export default PurposeListMental;